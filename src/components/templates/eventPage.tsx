      ...
      <Section>
        ...
        <ol className="max-w-5xl mx-auto space-y-16 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-10 md:gap-y-16 pt-6">
          {props.winners.map((winner, index) => (
            <li key={winner} className="relative p-4 rounded-lg shadow-lg bg-white text-center">
              <div className=" text-5xl font-bold absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center h-20 w-20 rounded-full border-4 border-white bg-green-600 text-gray-100 shadow ">
                {index + 1}
              </div>
